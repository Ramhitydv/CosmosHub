...
#[derive(Debug)]
pub struct CosmosHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CosmosHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CosmosHub processing");
    
    let mut processor = CosmosHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CosmosHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CosmosHubProcessor::new(false);
